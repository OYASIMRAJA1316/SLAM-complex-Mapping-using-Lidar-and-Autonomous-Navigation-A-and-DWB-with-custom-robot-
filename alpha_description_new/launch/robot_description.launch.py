...
def generate_launch_description():
    ...
    description_package_path = get_package_share_directory('alpha_description_new')
    urdf_path = os.path.join(description_package_path, 'urdf/alpha.xacro')
    rviz_config_file = os.path.join(description_package_path, 'rviz/view.rviz')

    robot_description = ParameterValue(Command(['xacro ', urdf_path]), value_type=str)
    
    # (Dynamic TF conversion)
...
if __name__ == '__main__':
    # LaunchDescription(create a LaunchDescription object)
